import 'package:core/src/component/atoms/pokemon_spacing.dart';
import 'package:core/src/component/molecules/pokemon_status_message.dart';
...
extension GlobalKeyPokemonTextFieldStateExtension
    on GlobalKey<PokemonTextFieldState> {
...
class PokemonTextField extends StatefulWidget {
  ...
  @override
  State<PokemonTextField> createState() => PokemonTextFieldState();
}

class PokemonTextFieldState extends State<PokemonTextField> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.title != null) const PokemonSpacing.vertical8(),
        TextField(
