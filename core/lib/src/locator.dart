...
void setupLocatorFeatureCore() {
  ...
  locator.registerLazySingleton(
    () => MorphemeHttp(
      ...
      //       request.url == PokemonEndpoints.login,
      ...
      //       request.url == PokemonEndpoints.logout,
      //   onClearToken: () => FlutterSecureStorageHelper.removeToken(),
      //   excludeEndpointUsageToken: [
      //     PokemonEndpoints.login,
      //     PokemonEndpoints.register,
      //   ],
      // ),
      // refreshTokenOption: RefreshTokenOption(
      //   method: RefreshTokenMethod.post,
      //   url: PokemonEndpoints.refreshToken,
      //   condition: (request, response) =>
      //       request.url != PokemonEndpoints.login && response.statusCode == 401,
      //   getBody: () async {
      //     final refreshToken =
